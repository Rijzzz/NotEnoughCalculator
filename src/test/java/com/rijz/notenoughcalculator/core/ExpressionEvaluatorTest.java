...
class ExpressionEvaluatorTest {
    ...
    class TaxAndAngleFunctions {
        ...
        void verifyAllAhDurationFeeMilestones() {
            ...
            double[] expectedFees = { 20, 25, 30, 35, 40, 45, 50, 60, 70, 80, 90, 100, 120, 140, 160, 180, 200, 220,
                    240, 260, 280, 300, 320, 350, 1200, 3000, 7200, 12000, 16800, 21600, 26400, 31200, 36000, 40800,
                    45600, 50400, 55200 };
