...
public final class SlayerXpTable {
    ...
    private static final long[] ZOMBIE_WOLF_XP_TABLE = {
            0L,
            5L, 15L, 200L, 1000L, 5000L, 20000L, 100000L, 400000L, 1000000L
    };

    private static final long[] SPIDER_XP_TABLE = {
            0L,
            5L, 25L, 200L, 1000L, 5000L, 20000L, 100000L, 400000L, 1000000L
    };

    private static final long[] ENDERMAN_BLAZE_XP_TABLE = {
            0L,
            10L, 30L, 250L, 1500L, 5000L, 20000L, 100000L, 400000L, 1000000L
    };

    private static final long[] VAMPIRE_XP_TABLE = {
            0L,
            20L, 75L, 240L, 840L, 2400L
    };
