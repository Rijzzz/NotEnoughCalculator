...
As of February 2nd, 2026, the project has been relicensed under the **GNU Lesser General Public License v3.0 or later (LGPL-3.0-or-later)**.

### What this means:

* **Open Source:** The project itself is now free and open source.
* **Modifications:** Any modifications or forks of this project's code must still be released under the LGPL-3.0-or-later.
