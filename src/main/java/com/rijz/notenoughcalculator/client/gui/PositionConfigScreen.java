...
public class PositionConfigScreen extends Screen {
    ...
    protected void init() {
        ...
        addRenderableWidget(Button.builder(Component.translatable("notenoughcalculator.position.screen.btn_center"), btn -> {
            ...
            this.currentY = this.height - 22;
                ...
                .tooltip(Tooltip.create(Component.translatable("notenoughcalculator.config.tooltip.center_bottom")))
                .build());

        addRenderableWidget(Button.builder(Component.translatable("notenoughcalculator.position.screen.btn_reset"), btn -> {
            this.currentX = -1;
            this.currentY = -1;
        ...
        addRenderableWidget(Button.builder(Component.translatable("notenoughcalculator.position.screen.btn_save"), btn -> {
            saveAndClose();
        ...
        addRenderableWidget(Button.builder(Component.translatable("notenoughcalculator.position.screen.btn_cancel"), btn -> {
            closeScreen();
