...
public class SkyblockTaxCalculatorTest {
    ...
    void testCalculateBzPayout() {
        assertEquals(0, new BigDecimal("98750000").compareTo(SkyblockTaxCalculator.calculateBzPayout(new BigDecimal("100000000"), 1.25)));
        assertEquals(0, new BigDecimal("98875000").compareTo(SkyblockTaxCalculator.calculateBzPayout(new BigDecimal("100000000"), 1.125)));
        assertEquals(0, new BigDecimal("99000000").compareTo(SkyblockTaxCalculator.calculateBzPayout(new BigDecimal("100000000"), 1.0)));
    ...
    void testCalculateAhPayout() {
        assertEquals(0, new BigDecimal("46999955").compareTo(SkyblockTaxCalculator.calculateAhPayout(new BigDecimal("50000000"), 6.0, false)));
        assertEquals(0, new BigDecimal("48499955").compareTo(SkyblockTaxCalculator.calculateAhPayout(new BigDecimal("50000000"), 6.0, true)));
        assertEquals(0, new BigDecimal("4899955").compareTo(SkyblockTaxCalculator.calculateAhPayout(new BigDecimal("5000000"), 6.0, true)));
        assertEquals(0, new BigDecimal("192999955").compareTo(SkyblockTaxCalculator.calculateAhPayout(new BigDecimal("200000000"), 6.0, true)));
